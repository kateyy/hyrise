...
const std::string Division::vname() {
  return "Division";
}

void Division::setVType(const int &vtype){
  _vtype = vtype;
}

void Division::setColName(const std::string &colName){
  _colName = colName;
}

int Division::getVType() const {
  return _vtype;
}

std::string Division::getColName() const {
  return _colName;
}
