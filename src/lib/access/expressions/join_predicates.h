...
template <typename T>
class GreaterThanJoinExpression : public JoinExpression {
 private:
  hyrise::storage::c_atable_ptr_t left;
  hyrise::storage::c_atable_ptr_t right;
 ...
 public:
  ...
  GreaterThanJoinExpression(size_t l, field_t _left, size_t r, field_t right):
      left_field(_left), right_field(right), left_input(l),
      right_input(r)
  {}

  GreaterThanJoinExpression(size_t l, field_name_t _left, size_t r, field_name_t right):
      _left_field_name(_left), _right_field_name(right), left_input(l),
      right_input(r)
  {}

  GreaterThanJoinExpression(hyrise::storage::c_atable_ptr_t _left,
                       field_t _left_field,
                       hyrise::storage::c_atable_ptr_t _right,
                       field_t _right_field) :
      left(_left), right(_right), left_field(_left_field), right_field(_right_field) { }
  ...
  static GreaterThanJoinExpression<T> *parse(const Json::Value &value) {
    if (value["field_right"].isNumeric()) {
      return new GreaterThanJoinExpression<T>(value["input_left"].asUInt(),
                                         value["field_left"].asUInt(),
                                         value["input_right"].asUInt(),
                                         value["field_right"].asUInt());
    }
